...
User.create(username: 'username1', firstname: 'Wendy', lastname: '', password: 'Password1', email: 'asdf1@email.com', role_id: 4, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username2', firstname: 'Lin', lastname: 'Wei', password: 'Password2', email: 'asdf2@email.com', role_id: 4, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username3', firstname: 'David ', lastname: 'McDonald', password: 'Password3', email: 'asdf3@email.com', role_id: 4, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username4', firstname: 'Victor', lastname: 'Schmatter', password: 'Password4', email: 'asdf4@email.com', role_id: 4, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username5', firstname: 'Janice', lastname: 'Wong', password: 'Password5', email: 'asdf5@email.com', role_id: 4, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username6', firstname: 'Andy ', lastname: 'Lee', password: 'Password6', email: 'asdf6@email.com', role_id: 4, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username7', firstname: 'Wilson', lastname: 'Chan', password: 'Password7', email: 'asdf7@email.com', role_id: 4, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username8', firstname: 'Devin ', lastname: 'Sim', password: 'Password8', email: 'asdf8@email.com', role_id: 4, created_at: Time.now, updated_at: Time.now)