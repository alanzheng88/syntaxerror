...
User.create(username: 'username3', firstname: 'David ', lastname: 'McDonald', password: 'Password3', email: 'asdf3@email.com', rolekey: 4, userlistkey: 3, created_at: Time.now, updated_at: Time.now)
...
User.create(username: 'username5', firstname: 'Janice', lastname: 'Wong', password: 'Password5', email: 'asdf5@email.com', rolekey: 4, userlistkey: 5, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username6', firstname: 'Andy ', lastname: 'Lee', password: 'Password6', email: 'asdf6@email.com', rolekey: 4, userlistkey: 6, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username7', firstname: 'Wilson', lastname: 'Chan', password: 'Password7', email: 'asdf7@email.com', rolekey: 4, userlistkey: 7, created_at: Time.now, updated_at: Time.now)
User.create(username: 'username8', firstname: 'Devin ', lastname: 'Sim', password: 'Password8', email: 'asdf8@email.com', rolekey: 4, userlistkey: 8, created_at: Time.now, updated_at: Time.now)